...
app.controller("basketballCtrl", function($scope, $filter){
	this.players = data;
	this.reverse = false;
	this.current = '';
	this.testing = true;
	...
	this.checkSearch = function(player){
		var fullName = player.first + player.last;
		var val = document.getElementById('searcher').value;
		
		console.log("val is: " + val);
		console.log("fullName is: " + fullName);
		
		//if(fullName.includes(val.trim().replaceAll("\\s+",""))){
	...
	this.showShootingPercent = function(player){
		console.log("player  currently is: " + player.first);
		var attempted = (player.fieldGoalsAttempted + player.twoPointsAttempted + player.threePointsAttempted + player.freeThrowsAttempted );
		var made = (player.fieldGoals + player.twoPoints + player.threePoints + player.freeThrows);
